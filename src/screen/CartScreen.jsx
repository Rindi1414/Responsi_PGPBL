...
const CartScreen = () => {
  const { cartItems, deleteCartItem, totalPrice, clearCart } = useContext(CartContext);
  ...
  const handleCheckout = () => {
    if (cartItems.length > 0) {
      Alert.alert("Pesanan berhasil", "Terima kasih sudah berbelanja!");
    } else {
          ...
          <>
            <View style={styles.bottomContentContainer}>
              <View style={styles.flexRowContainer}>
                ...
                <Text style={styles.priceText}>Rp{totalPrice}</Text>
              </View>
              <View style={styles.flexRowContainer}>
                <Text style={styles.titleText}>Shipping:</Text>
                <Text style={styles.priceText}>Rp0.0</Text>
              </View>
